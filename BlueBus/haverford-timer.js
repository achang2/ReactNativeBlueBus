...
import { nextBusTime } from "./bus-times-table-parser";
...
updateClock = () => {
  ...
  //This is a placeholder; eventually this needs to get changed to make a request based on which view we're in
